...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2014 at 12:09 AM
...
(3, 'Internal', 'Scanning'),
(4, 'Web', 'Enumeration'),
(5, 'Web', 'drop web shell'),
(6, 'Web', 'Web shell'),
(7, 'Internal', 'arp posing');
...
(2, 'New Company1', 'John', 'mayer', '1234 froyo st', 'frouo', 'dh', '29902'),
(3, 'Company 2', 'frank', 'castle', '870 killer ln', 'lalaland', 'la', '29031');
...
INSERT INTO `engagements` (`id`, `company`, `engagement_name`, `username`, `complete`, `start`, `stop`, `report_id`) VALUES
(47, 'OpenWire', 'OpenWire-Internal', 'user2', '50', '2014-03-25', '2014-03-28', 47);
...
(13, 'Test finding', 'Custom', 2, 2, 6, 5, 3, 'test effort', 'test summary', 'test recommendations', 1, NULL, NULL),
(14, 'my new finding', 'Custom', 5, 2, 5, 5, 2, 'fdnajnad', 'jlkjkljk', 'nlknlkklj', 1, NULL, NULL);
...
(15, 'Scanning', '0', 'OpenWire-Internal'),
(16, 'Scanning', '0', 'OpenWire-Internal');
...
(56, 'Scanning', 'OpenWire-Internal', 'user2', NULL, 1),
(57, 'arp posing', 'OpenWire-Internal', 'user2', NULL, 0);
...
(1, '');
...
(6, 'user1', '4e8d880969512e26c40741cec4ccd3ed64a7c540287d1ad6720e8185960e2621', '#qAvSodme5Q?42BgIn%wyrd7Jc3wU7be', 1),
(7, 'user2', '2d6b3d75cd46c938413fc93f0eb89e398b4c76be24b895fd7a92fa7d56c65263', 'Z&QlUSKQpLJ3rgoe9DJH#6Cufq0Bkl2L', 1);
